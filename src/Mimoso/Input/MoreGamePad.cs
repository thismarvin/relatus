...
namespace Mimoso.Input
{
    ...
    class MoreGamePad
    {
        ...
        {
            if (!isBeingUpdated)
                throw new MimosoException("Make sure to call your MoreGamePad's Update() method before you use any of the built in methods.", new MethodExpectedException());
        }
    }
}
